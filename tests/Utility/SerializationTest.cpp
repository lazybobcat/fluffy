    ...
    describe("Serialization Utility", [&](){
        ...
        describe("serialize to json", [&]() {
            it("should serialize to json", [&]() {
                ...
                bool r = Fluffy::Utility::JsonSerializer::serializeToString(object, json);
        ...
        describe("deserialize from json", [&]() {
            it("should deserialize from json", [&]() {
                ...
                bool r = Fluffy::Utility::JsonSerializer::deserializeFromString(json, object);
        ...
        describe("serialize to file", [&]() {
            it("should serialize to file", [&]() {
                ...
                bool r = Fluffy::Utility::JsonSerializer::serializeToFile(object, filename);
        ...
        describe("deserialize from json", [&]() {
            it("should deserialize from file", [&]() {
                ...
                bool r = Fluffy::Utility::JsonSerializer::deserializeFromFile(filename, object);
