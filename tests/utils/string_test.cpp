    ...
    describe("String utils", [](){
        ...
        describe("replaceAll function", [&]() {
            ...
            it("should replace an occurrence", [&](){
                ...
                Fluffy::replaceAll(result, pattern, replacement);
        ...
        describe("printString function", [&]() {
            ...
            it("should replace all placeholders", [&](){
                ...
                auto result = Fluffy::printString(base, {"Banana", "Kiwi"});
                AssertThat(result, Equals(expected));
            });
            ...
            it("shouldn't infinite loop replace on itself", [&](){
                ...
                auto result = Fluffy::printString(base, {"Banana", "%1"});
                AssertThat(result, Equals(expected));
            });
        ...
        describe("toString function", [&]() {
            ...
            it("should return numeric as string", [&](){
                AssertThat(Fluffy::toString(42), Equals("42"));
                AssertThat(Fluffy::toString(42.3), Equals("42.3"));
                AssertThat(Fluffy::toString(42.f), Equals("42"));

                UltimateQuestionOfLifeTheUniverseAndEverything question;
                AssertThat(Fluffy::toString(question), Equals("42"));
            });
